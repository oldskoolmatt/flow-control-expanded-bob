...
assign_subgroup("flowbob-check-valve",		"valves-2", "1")
assign_subgroup("flowbob-overflow-valve",	"valves-2", "2")
assign_subgroup("flowbob-topup-valve-1",	"valves-2", "3")
assign_subgroup("flowbob-topup-valve-2",	"valves-2", "4")
