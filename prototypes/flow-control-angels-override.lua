...
for material, map in pairs(material_map) do
	...
	if data.raw["storage-tank"] and data.raw["storage-tank"]["pipe-" .. material .. "-straight"] then
		...
		data.raw["storage-tank"]["pipe-" .. material .. "-straight"].fluid_box.pipe_covers = flow_bob_pipe_covers_pictures(material, covers_path)
	end
	...
	if data.raw["storage-tank"] and data.raw["storage-tank"]["pipe-" .. material .. "-junction"] then
		...
		data.raw["storage-tank"]["pipe-" .. material .. "-junction"].fluid_box.pipe_covers = flow_bob_pipe_covers_pictures(material, covers_path)
	end
	...
	if data.raw["storage-tank"] and data.raw["storage-tank"]["pipe-" .. material .. "-elbow"] then
		...
		data.raw["storage-tank"]["pipe-" .. material .. "-elbow"].fluid_box.pipe_covers = flow_bob_pipe_covers_pictures(material, covers_path)
	end
end